...
%.stars.tif: $(MAGICK) ## Create stars and mask tifs from $*
	$(MAKE) $*.starless.tif
	$< $*.tif $*.mask.tif -alpha off -compose CopyOpacity -composite $@
